...
<div class="main-div">
<h1 class="text-center">LIST OF CONSIGNMENT</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6    col-12">
                                    ...
                                    <div class="col-lg-6 col-md-6    col-12">
                                        ...
                                        <div class="col-lg-6 col-md-6    col-12">
                                        <?php echo $d['delivery_report']?> </div>   <div class="col-lg-6 col-md-6    col-12">
                                        <label for="">Bid</label>
                                        </div>
                                        <form action="bid.php" method="POST">
                                        
                                            <div class="col-lg-6 col-md-6    col-12"  >
                                            <input type="text"  name="c" id="c" hidden value="<?php echo $d['consignment_no']?>"><?php echo $d['consignment_no']?> </div>
                                        
                                            <div class="col-lg-6 col-md-6    col-12">
                                            <div class="col-lg-6 col-md-6    col-12 ">
                                            <button type="submit" id="submit" class= "btn btn-primary form   "  style="margin:15%;" name="submit" value="LOGIN" >BID</button>
