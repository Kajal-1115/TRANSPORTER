...
<div class="main-div"> 
        ...
        <div class="center-div"> 
            <div class="col">  
                <div>
                    <?php  $z1="SELECT * FROM `bid`";
                    $sql1=mysqli_query($con,$z1); ;
                    ...
                    <section class="my-5 py-5">
                            ...
                            <div>
<h1 class="text-center"><span  style="background-image: repeating-linear-gradient( 45deg,white 3% ,   blue 4%);">  LIST OF BID</h1> 
                            </div>
                            <div class="w-50 m-auto">
                                ...
                                <div class="col-lg-6 col-md-6    col-12">
                                    ...
                                    <div class="col-lg-6 col-md-6    col-12"> <?php echo $d1['date_of_delivery']?>
                                    </div>      
             ...
             $sql=mysqli_query($con,$z); ;
                ...
                while($d=mysqli_fetch_assoc($sql)){ 
                    if($d1['consignment_no']===$d['consignment_no']){
                               ?>
                    <section class="my-5 py-5">
