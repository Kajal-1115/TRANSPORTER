...
$da="select *from client";
$db=mysqli_query($con,$da)or die(" quary failed");

// $dc=mysqli_fetch_assoc($db);
// $dd=$dc['varid'];
// $de=$dc['numid'];
// $df=$de+1;
$de=$a."_".$af; 
$dg=$de;
// $qr="update client set user_name='$de'";
// mysqli_query($con,$qr); 
$xy="INSERT INTO `client`( `user_name`, `password`, `type`, `name`, `fathers_name`, `birth`, `gender`, `nationality`, `present_state`, `present_dist`, `present_address`, `present_pin`, `permanent_state`, `permanent_dist`, `permanent_address`, `permanent_pin`, `mobile`, `email`, `language1`, `read1`, `write1`, `speak1`, `language2`, `read2`, `write2`, `speak2`, `language3`, `read3`, `write3`, `speak3`, `uid`, `company_registration`, `company_address`, `company_pin`, `photo`, `signature`, `id_proof`, `address_proof`) 
VALUES  ( '$dg', '$pw', '$a', '$b','$c','$d','$e','$f','$g','$h','$i',$j,'$k','$l','$m',$n,$o,'$p','$q','$r','$s','$t','$u','$v','$w','$x','$y','$z','$aa','$ab',
 $ac, '$ad', '$ae', '$af', '$ag', '$ah', '$ai', '$aj')"; 
$m= mysqli_query($con,$xy);
...
<div>
  ...
  <div id="register_a"> 
  <center><h2>You are Successfully Registered...</h2></center> 
  <center>
  <div class="row">
  ...
  <center><a href="client_home.php"><h2>HOME</h2></a></center>
  </div>  
