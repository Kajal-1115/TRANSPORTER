   ...
   if ($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        if(!$qu)
        {
          ...
          $aa=$_POST['write3'];
          $ab=$_POST['speak3'];
        $xy="UPDATE `client` SET `language1`='$qa',`read1`=' $r',`write1`='$s',`speak1`='$t',`language2`='$u',`read2`='$v',`write2`='$w',`speak2`='$x',`language3`='$y',`read3`='$z',`write3`='$aa',`speak3`='$ab'  WHERE user_name='$q'";
