...
<section class="my-5">
      <div class="py-5"> 
        ...
        <div class="w-50 m-auto">
            <form  id="client" name="client" action="client_registration_action.php "    method="POST" onSubmit="return call(this.form);" >
                 <div class="form-group text-white">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6    col-12">
                          <input type="text" readonly id="client_registration" name="client_registration" value="Client"  autocomplete="off"  class="input-box form-control" >
                         </div>
                        <div class="col-lg-6 col-md-6    col-12">
                          <label for=""> NAME</label>
                         </div>
                        <div class="col-lg-6 col-md-6    col-12">
                          <input type="text" id="client_name" name="client_name" placeholder="Full Name" title="Enter Your Full Name"  class="input-box form-control" required autofocus>
                         </div> <br>
                        <div class="col-lg-6 col-md-6    col-12">
                    ...
                    <div class="col-lg-6 col-md-6    col-12"><label for="">  Check  password same or not.</label></div>
                         <div class="col-lg-6 col-md-6    col-12"><input type="checkbox" name="check_pw" onClick="same1(this.form)" class="checkbox  form-control"></div>
