...
<h1>ONLINE BIDDING FOR LOGISTIC SYSTEM(BILS)</h1>
    <meta charset="UTF-8">
...
<section class="my-5">
      <div class="py-5"> 
         <h2 class="text-center"><span  style="background-image: repeating-linear-gradient( 45deg,white 3% ,   blue  4%);">CLIENT PROFILE</span></h2> 
        </div>
        <div class="w-50 m-auto">
            <form  id="cli-home" name="cli_home" action="client_home.php"   method="post" 
  
                <div class="form-group text-white">
                    <div class="row">
                        <div class="col-lg-6 col-md-6    col-12">
                        <label for=""> CLIENT CUSTOMER PROFILE</label>
                        </div>
                        <div class="col-lg-6 col-md-6    col-12">
                        <input type="text" readonly id="client customer profile" name="client customer profile" value="CLIENT-CUSTOMER PROFILE"  autocomplete="off"  class="input-box form-control">
                        </div>
                        <div class="col-lg-6 col-md-6    col-12">
                         <label for=""> NAME</label>
                        </div>
                        <div class="col-lg-6 col-md-6    col-12">
                         <input type="text" id="client_name" name="client name" placeholder="Full Name" title="Enter Your Full Name"  class="input-box form-control" autofocus>
                         </div>
                    <div class="col-lg-6 col-md-6    col-12">
                    ...
                    <div class="col-lg-6 col-md-6    col-12">
                      ...
                      <div class="col-lg-6 col-md-6    col-12">
                        ...
                        <div class="col-lg-6 col-md-6    col-12">
                        <input type="number" id="mobile number" name="mobile number" placeholder="Mobile Number"  class="input-box form-control">
                    </div>
                     <div class="col-lg-6 col-md-6    col-12">
                    ...
                    <div class="col-lg-12 col-md-12   col-12">
                     ...
                     <div class="col-lg-6 col-md-6    col-12">
                        ...
                        <div class="col-lg-6 col-md-6  col-12">
                        <input type="text" id="uid number" name="uid _number" class="input-box form-control">
                        </div>
                    <div class="col-lg-6 col-md-6    col-12">
                   ...
                   <label for="">Company reg.Number</label>
                    ...
                    <div  class="col-lg-6 col-md-6  col-12">
                    <input type="text" id="company reg number" name="Company reg. Number" class="input-box form-control">
                     </div>
                     <div class="col-lg-6 col-md-6  col-12">
                     <label for="">Company Address</label>
                     </div>
                     <div class="col-lg-6 col-md-6  col-12">
                     <input type="text" id="company address" name="Company address" class="input-box form-control">
                    </div>
                    <center>
