...
if ($_SERVER["REQUEST_METHOD"]=="POST")
 {
   ...
   else
   {
	   ...
	   $a=$_POST['user_name'];
	   $b=$_POST['password']; 
	   $qu="SELECT *from transporter_owner where user_name='$a'&& password='$b'";
...
?>
 ...
 <section  class="my-5 ">
        <div class="py-5"> 
         <h2 class="text-center" style=" color: white;"> Transporter LOGIN</h2> 
        </div>
      <center>
                 ...
                 <div class="card"  >
                    ...
                    <form  action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="user_name" name="user_name" class="input_login form-control   " required>
                        </div> 
                        <div class="form-group">
